export const it = {
  settings: {
    /********** Generic **********/
    'change-pw-success': 'Password modificata con successo!',
    'change-pw-fail': 'Errore durante la modifica della password, riprova più tardi',
    ...
    'passwordmanager-setting': 'Gestore delle password',
    'wallet-setting': 'Il mio portafoglio',
    'wallet-connect-sessions-setting': 'Sessioni Wallet Connect',
    ...
    lightweight: 'Leggera',
    advanced: 'Avanzata',
    'lightweight-mode-enabled': 'Modalità Leggera Abilitata',
    'lightweight-mode-disabled': 'Modalità Leggera Disabilitata',
    ...
    'new-version-available-notif-info':
      'A new version of Essentials ({{ latestVersion }}) is available in your app store, update now to get the latest features and fixes!',
    ...
    'background-services-enabled': 'Servizi in background abilitati',
    'background-services-disabled': 'Servizi in background disabilitati',
    'configure-network': 'Configura rete',
    on: 'ON',
    off: 'OFF',
    ...
    'test-net': 'Rete di prova',
    'main-net': 'Rete principale',
    'reg-net': 'Rete Regression',
    'priv-net': 'Rete privata',
    ...
    'display-mode-restart-prompt':
      "La modifica della modalità di visualizzazione richiede il riavvio dell'app per avere effetto",
    ...
    'wallet-connect-prepare-to-connect': 'Preparazione di Wallet Connect',
    'wallet-connect-popup': "Operazione completata, si prega di tornare all'app originale.",
    'wallet-connect-session-disconnected': 'Sessione Wallet Connect disconnessa',
    'wallet-connect-error': "Un'applicazione esterna ha appena inviato una richiesta non supportata da Essentials.",
    'raw-request': 'Richiesta non elaborata: ',
    'wallet-connect-request-loading': "Tentativo di connessione a un'applicazione esterna tramite Wallet Connect",
    'wallet-connect-request-error1': 'Sembra che il collegamento non possa essere effettuato. Per favore ',
    ...
    'wallet-connect-request-error3':
      "La connessione sembra richiedere troppo tempo. Puoi annullare e riprovare dall'applicazione originale.",
    ...
    'wallet-connect-no-session-info':
      "Al momento tramite Wallet Connect non c'è alcuna connessione con dApp di terze parti. Trova il pulsante Wallet Connect nella dApp esterna e scansiona il codice QR fornito con lo Scanner di Essentials.",
    'wallet-connect-no-address':
      'No active wallet, or active network is not compatible with Ethereum. This is not an error, but please make sure you are on the expected network. Some dApps may disconnect your Wallet Connect session because of this.',
    ...
    'startupscreen-wallets-description':
      'Se i tuoi fondi sono la tua priorità. Visualizza il tuo portafoglio attivo come schermata iniziale.',
    'startupscreen-dapps-title': 'Portale DApps',
    'startupscreen-dapps-description':
      'Non puoi fare a meno di navigare nelle dApps? Questa è la modalità che fa per te.',
    ...
    'privacy-use-hive-data-sync':
      'Use my Elastos Hive vault storage to save and restore personal data such as DID credentials or contacts list',
    ...
    'elastos-io-des':
      'Set di API Elastos implementate e mantenute dal team Gelaxy, noto anche come team blockchain Elastos.',
    'trinity-tech-io-des':
      'Set di API Elastos distribuite e gestite dal team Trinity Tech, responsabile degli SDK Elastos e degli sviluppi Essentials.',

    'privacy-toolbox-stats': 'Credentials statistics',
    'privacy-send-credential-toolbox-stats':
      'Send anonymous information about DID usage to the credential toolbox (a developer tool). The DID itself is never sent.',
    'privacy-dont-send-credential-toolbox-stats':
      "Don't send anonymous information about DID usage to the credential toolbox (a developer tool).",
    ...
    elastosapiprovider: 'APIs di Elastos'
  }
};
