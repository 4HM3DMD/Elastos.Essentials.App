export const en = {
  settings: {
    ...
    'applock-setting': 'App Lock',
    'applock-setting-sub': 'Password, auto-lock & screenshots',
    'applock-title': 'App Lock',
    'applock-change-password': 'Master password',
    'applock-change-password-sub': 'Change your master password',
    'applock-block-screenshots': 'Block screenshots',
    'applock-block-screenshots-sub': 'Prevent screenshots and screen recording of the app',
    'autolock-setting': 'Auto-lock',
    'autolock-setting-sub': 'Require your password after inactivity',
    'autolock-title': 'Auto-lock',
    'autolock-intro': 'Choose how long Essentials stays unlocked after you leave it. A shorter time is more secure; after this delay you will be asked for your master password again.',
    'autolock-immediately': 'Immediately',
    'autolock-1min': 'After 1 minute',
    'autolock-5min': 'After 5 minutes',
    'autolock-15min': 'After 15 minutes',
    'autolock-30min': 'After 30 minutes',
    'autolock-1hour': 'After 1 hour',
    ...
    'wallet-connect-request-error3':
      'Connection seems to take a long time. You could cancel it and try again from the original app.',
    ...
    'wallet-connect-no-session-info':
      "There is currently no session with a third party app through Wallet Connect. Find the Wallet Connect button on your external app and scan the provided QR code using Essentials' scanner to start.",
