export const zh = {
  wallet: {
    ...
    'find-new-tokens-warning-msg': '备注：请注意，某些代币可能是恶意的。仅当您了解它们后才去使用它们。',
    'nft-name': '名称',
    'nft-description': '描述',
    ...
    'text-did-balance-not-enough':
      '在链上写入DID信息需要少量的ELA来支付费用。请先从主钱包中将ELA（例如：0.1 ELA）充值到EID侧链！',
    'amount-null': '请输入交易金额',
    'amount-invalid': '请输入正确的金额',
    'eth-insuff-balance': '您必须有足够的 {{ coinName }} 来支付gas费，才能发送此代币',
    ...
    'coin-op-producer-register': 'BPoS参选',
    ...
    'coin-op-dpos2-claim-reward': 'BPoS 领取奖励',
    ...
    'coin-transfer-recharge-title': '{{coinName}} 侧链充值',
    'coin-transfer-withdraw-title': '主链提现',
    'payment-title': '支付',
    'transfer-from': '来自',
    'transfer-to': '转账到',
    ...
    'ela-coinbase-warning':
      '请确保不要将 Elastos Smart Chain 的 ELA 发送到 Coinbase 地址，因为 Coinbase 上的 ELA 是基于以太坊网络的 ERC20 ELA。',
    'ela-eid-warning':
      '请确认接收地址属于 Elastos Identity Chain，不要将 Elastos Identity Chain 上的 ELA 直接转到 Elastos Smart Chain 或其他 EVM 链。',
    'nft-transaction-creation-error':
      '似乎无法对此 NFT 进行转让操作。一些 NFT 被锁定，需要特殊条件才能转让。请咨询原始 NFT 市场或 NFT 创建者。',
    'btc-feerate': '费率',
    'btc-feerate-fast': '快速',
    'btc-feerate-avg': '普通',
    'btc-feerate-slow': '慢',
    'btc-feerate-custom': '自定义',
    'btc-feerate-select-title': '选择费率',
    'btc-feerate-custom-input-title': '自定义费率',
    'btc-feerate-custom-input-message': '请输入费率 (sat/vB)',
    'btc-feerate-custom-input-placeholder': '费率 (sat/vB)',
    'btc-feerate-custom-input-invalid': '请输入有效的费率',
    'btc-feerate-low-warning-title': '低费率警告',
    'btc-feerate-low-warning-message': '您输入的费率 ({{ feerate }} sat/vB) 低于慢速费率 ({{ slowFeerate }} sat/vB)。这可能导致您的交易确认时间非常长，或者交易永远不会被确认，最终从内存池中被丢弃。您确定要继续吗？',
    'btc-inscription-utxos-title': '此交易将使用含有铭文的UTXO',
    'btc-inscription-utxos-info':
      '您的账户中含有铭文 UTXO 总金额：{{ utxos }} BTC，使用此类UTXO会导致资产流失，请确认是否继续！',
    ...
    'wallet-settings-migrate-did1-intro':
      '这是一次性操作。 此次转账会将您所有剩余的资金从现已弃用的 DID 1.0 亦来云侧链迁移到亦来云主链。 之后，DID 1.0 子钱包将从您的钱包中消失。',
    ...
    'delete-coin-confirm-subtitle':
      '该币种将从您的钱包中删除，但您的币种余额是安全的。 要使用和查看您的币种余额，您必须再次添加此币种。',
    ...
    'notification-found-claimable-nfts':
      '钱包 {{ walletname }} 在 Elastos Smart Chain 上有 {{ count }} 个可申领的 BPoS NFT！',
    ...
    'esctransaction-estimated-fees': '预估手续费:',
    ...
    'signtypeddata-danger':
      '对此数据签名可能会很危险。此签名可能代表您的帐户执行任何操作，包括将您的帐户及其所有资产的完全控制权授予请求站点。只有在你知道自己在做什么或完全信任请求网站的情况下，才能签署此消息。',
    ...
    'help:create-password':
      '助记词密码是可选的，但它为您的钱包提供了更高的安全性。您可以将其视为自定义的第13个助记词。请注意，如果忘记了该密码，将无法恢复钱包。在恢复您的钱包时输入错误的助记词密码不会产生任何错误，但恢复的将是另一个钱包。',
    'help:import-password':
      '助记词密码是与助记词绑定的自定义密码。 如果您在创建钱包时使用了助记词密码，则导入时必须使用相同的助记词密码，反之，则无需助记词密码，否则恢复的将是另一个钱包。',
    'privatekey-tap-to-copy': '点击私钥即可复制',
    'export-private-key-intro': '您可以在某些钱包中使用以下 EVM 私钥。点击私钥即可复制。',
    'export-tron-private-key-intro': 'Tron 网络私钥',
    'export-btc-private-key-intro': 'Bitcoin 网络私钥',
    ...
    'multi-sig-error-invalid-xpub': '请输入有效的扩展公钥',
    ...
    'multi-sig-extended-public-key-note-info':
      '此扩展公钥是使用BIP45派生的，以便在多签钱包中使用，而由于历史原因，您的 Elastos 主链钱包使用BIP44。',
    ...
    'ext-tx-info-type-renewal-order-request': '订单延期',
    ...
    'text-consolidate-note-ledger':
      'UTXO 数量过多可能会导致一些交易失败，Ledger钱包目前一次只能合并 {{ count }} 个UTXO',
    'reasons-failure': '失败原因',
    'notification-too-many-utxos':
      '钱包 {{ walletname }} 的ELA 主链中的 UTXO 个数已达到 {{ count }}，建议您执行零钱换整！',
