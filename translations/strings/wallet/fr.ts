export const fr = {
  wallet: {
    ...
    'find-new-tokens-warning-msg':
      'Remarque : veuillez faire attention, certains jetons peuvent être malveillants. Ne les utilisez que si vous les connaissez.',
    'nft-name': 'Nom',
    ...
    'text-did-balance-not-enough':
      "Enregistrer des informations sur la châine d'identité requièrt une faible somme d'ELA pour les frais de transactions. Veuillez d'abord transférer un petit montant (ex: 0,1 ELA) depuis votre portefeuille principal vers le portefeuille EID!",
    ...
    'transaction-pending':
      'Une transaction est déjà en cours. Veuillez attendre la confirmation de la première transaction.',
    ...
    'hive-not-configured-text':
      "Votre espace de stockage Hive n'est pas configuré. Voulez-vous le configurer maintenant?",
    ...
    'wallet-manager-intro':
      'Les portefeuilles ont leurs propres paramètres. Vous pouvez configurer ces paramètres ci-dessous.',
    ...
    'coin-op-cr-register': 'Elastos Council Registration',
    'coin-op-cr-cancel': 'Elastos Council Cancellation',
    'coin-op-cr-update': 'Elastos Council Update',
    ...
    'coin-dir-from-mainchain': 'ELA Depuis mainchain',
    'coin-dir-from-idchain': 'Depuis la chaîne Identité',
    'coin-dir-from-ethsc': 'Depuis la chaîne ESC',
    'coin-dir-from-eco': 'Depuis la chaîne ECO',
    'coin-dir-from-pgp': 'Depuis la chaîne PGP',
    'coin-dir-to-mainchain': 'ELA Vers la chaîne principale',
    'coin-dir-to-idchain': 'Vers la chaîne Identité',
    'coin-dir-to-ethsc': 'Vers la chaîne ESC',
    'coin-dir-to-eco': 'Vers la chaîne ECO',
    'coin-dir-to-pgp': 'Vers la chaîne PGP',
    ...
    'crosschain-note':
      'Les transferts inter-chaînes prennent généralement entre 15 et 25 minutes. Vous ne verrez pas vos fonds pendant ce temps, veuillez patienter.',
    'balance-locked': '( {{ locked }} locked )',
    'ela-coinbase-warning':
      "N'envoyez pas d'ELA de la chaîne Elastos Smart Chain ELA vers une adresse Coinbase, car les ELA sur Coinbase sont des jetons ERC20 ethereum.",
    'ela-eid-warning':
    ...
    'nft-transaction-creation-error':
      'Il semble que le transfert ne puisse pas être réalisé pour ce NFT. Certains NFTs sont bloqués et nécessitent des conditions spéciales pour être transférés. Veuillez vous renseigner auprès de la marketplace ou du créateur du NFT.',
    ...
    'coin-receive-unavailable': "Cette adresse de réception est indisponible pour le moment. Veuillez revenir en arrière et réessayer.",
    'coin-receive-select-title': 'Recevoir',
    'coin-receive-select-subtitle': "Choisissez un réseau pour recevoir. Son adresse accepte tous les jetons de cette chaîne.",
    'coin-receive-select-empty': 'Aucun réseau disponible pour recevoir pour le moment.',
    ...
    'wallet-settings-delete-wallet-subtitle':
      'Votre argent ne sera pas supprimé. Vous pourrez réimporter votre portefeuille plus tard.',
    'wallet-settings-migrate-did1': 'Transfert des fonds DID 1.0',
    'wallet-settings-migrate-did1-subtitle':
      'Transfert des ELA restants de la châine DID 1.0 obsolète vers la chaîne principale',
    'wallet-settings-migrate-did1-intro':
      'Ceci est une opération unique. Vos fonds restants sur la chaîne DID 1.0 seront transférés vers la chaîne principale. Après cela, la chaîne DID 1.0 disparaîtra de votre portefeuille.',
    'delete-wallet-confirm-title': 'Supprimer le Portefeuille',
    'delete-wallet-confirm-subtitle':
      'Votre portefeuille sera supprimé de cet appareil. Vous pourrez le réimporter plus tard mais veillez à enregistrer votre mnémonique avant la suppression.',
    ...
    'wallet-settings-extended-public-keys-subtitle':
      'Clés spéciales requises pour créer des portefeuilles multi-signataires',
    ...
    'coin-list-enable-disable-coins-intro':
      'Sélectionnez les jetons que vous souhaitez afficher dans le portefeuille actuel.',
    ...
    'delete-coin-confirm-subtitle':
      'Ce jeton sera supprimé de votre portefeuille mais vos devises existeront toujours. Pour voir votre balance, vous devrez ajouter ce jeton à nouveau.',
    ...
    'coin-adderc20-invalid-contract-or-network-error':
      "Le contenu n'est pas une adresse de jeton ERC20 valide, ou erreur réseau.",
    ...
    'nft-non-transferable-notice':
      'Ce NFT n\'est pas transférable. Il ne peut pas être envoyé à une autre adresse.',
    ...
    elaaddress: 'Adresse ELA Principale',
    elaamount: "Solde d'ELA",
    ethaddress: 'Adresses EVM',
    btcaddress: 'Adresses BTC',
    tronaddress: 'Adresses Tron',
    requester: 'Demandé par',
    'text-allow': 'Autoriser',
    'text-share-mnemonic-warning':
      'Le mnémonique donne un accès total à tous vos actifs numériques. Veuillez confirmez que vous le partagez avec un tiers de confiance!',
     ...
     ************************/
    'crcouncilvote-title': 'Vote pour le Conseil Elastos',
    ...
    'esctransaction-approve-token-intro':
      'Cette application ou site web pourra retirer ou dépenser vos {{token}} pour vous.',
    ...
    'signtypeddata-intro':
      "L'application a besoin de signer certaines informations avec la signature de votre portefeuille. Veuillez confirmer pour continuer.",
    'signtypeddata-danger':
      "Signer ce message peut être dangereux. Cette signature peut éventuellement permettre à l'application de prendre le contrôle complet de votre portefeuille et de tous ses fonds. Ne signez ceci que si vous savez ce que vous faites ou si vous faites totalement confiance à l'application.",
    ...
    'signbitcoindata-danger':
      "Ne signez ceci que si vous savez ce que vous faites ou si vous faites totalement confiance à l'application.",
     ...
     *****************/
    'mnemonic-prompt1':
      'Voici vos 12 mots secrets (mnémonique). Si vous les perdez, vous perdez votre portefeuille, alors notez-les quelque part ',
    ...
    'mnemonic-warning3':
      'Ne partagez jamais votre mnémonique avec personne et gardez-le toujours en sécurité! Assurez-vous que personne ne regarde lorsque vous cliquez ci-dessous.',
    ...
    'help:create-password':
      "Il s'agit d'un mot de passe optionnel qui augmente la sécurité du mnémonique. Considérez-le comme un 13e mot du mnémonique. Notez bien que ce mot de passe ne pas pas être retrouvé si vous l'oubliez. Saisir un mauvais mot de passe de mnémonique dans l'avenir lorsque vous importerez votre portefeuille ne génèrera pas d'erreur mais créera une adresse de portefeuille différente, et vous ne verrez pas vos fonds.",
    'help:import-password':
      "Le mot de passe du mnémonique est un mot de votre choix qui est fortement associé à votre mnémonique. Ne tenez pas compte de cette option si vous n'avez pas utilisé de mot de passe de mnémonique lors de la création de votre portefeuille.",
    'privatekey-tap-to-copy': 'Toucher la clé privée pour copier',
    'export-private-key-intro':
      "Vous pouvez aussi choisir d'utiliser la clé privée evm suivante dans certaines applications. Touchez pour copier.",
    ...
    'import-wallet-by-privatekey-info':
      'Clé privée: Seules les clés privées des portefeuilles EVM (type Ethereum) sont supportées.',
    ...
    'providers-disclaimer':
      'Les services listés sur cette page sont des <b>services tiers non liés à Essentials</b>. Faites vos propres vérifications sur ces plateformes avant de les utiliser.',
    'finance-platforms': 'Plateformes Financières',
    'finance-platforms-intro':
      'Les plateformes suivantes peuvent gérer ce jeton pour éventuellement faire des bénéfices.',
    'get-more-tokens': 'Plus de Jetons',
    'get-more-tokens-intro':
      "Les fournisseurs de services tiers suivants vous permettent d'obtenir <b>plus de jetons {{coinName}}</b> en échangeant d'autres jetons:",
    'bridge-tokens': 'Convertir vos Jetons',
    'bridge-tokens-intro':
      "Les fournisseurs de services tiers suivants sont disponibles pour vous permettre de <b>convertir vos {{coinName}}</b> depuis/vers le réseau {{networkName}}, vers/depuis d'autres réseaux:",
    ...
    'multi-signature-transaction-link-copy-info':
      "Donnez ce lien aux autres co-signataires pour qu'ils puisse continuer le procesus.",
    ...
    'text-consolidate-note':
      "Trop d'UTXO peuvent provoquer l'échec de certaines transactions, il est recommandé de consolider.",
    'text-consolidate-note-ledger':
      "Trop d'UTXO peuvent provoquer l'échec de certaines transactions, il est recommandé de consolider. Le portefeuille Ledger ne peut fusionner que {{ count }} utxo à la fois.",
