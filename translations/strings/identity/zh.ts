export const zh = {
    ...
    'identity': {
        ...
        'credentials-verified': '凭证已验证',
        'current-actions': '当前操作',
        'current-options': '当前选项',
        'identity-not-published': '身份未发布',
        'identity-on-blockchain': '发布到链上',
        'add-more-information': '添加更多信息',
        'start-adding-more-to-your-profile': '补充档案',
        'my-identity': '我的身份',
        'export-mnemonics': '导出',
        'export-mnemonics-description': '显示我的助记词',
        'credentials-modified': '本地凭证未同步',
        'credentials-modified-description': '重新发布您的个人资料以进行同步',

        // page: profile
        'my-capsules': '我的胶囊',
        'show-all': '显示所有',
        'no-capsules-title': '没有胶囊',
        'no-capsules-text': '您可以从Elastos社区找到胶囊。根据这个胶囊，您可以将其注册到胶囊资料中，以供他人共享。',
        'not-set': '未设置',
        'credentials': '凭证',
        'male': '男',
        'female': '女',
        ...
        'credential-should-be-visible': '当前对每个人都可见',
        'credential-verified': '凭证已验证',
        'credential-unverified': '凭证未验证',
        'credential-not-published': '当前对其他人不可见',
        'credential-on-blockchain': '发布到链上',
        'verify-credential': '验证凭证',
        'reverify-credential': '重新验证凭证',
        'launch-external-app-to-verify': '启动外部应用程序验证',
        'validator': '验证器',
        'history': '历史',
        'issuance-date': '发行日期',
        ...
        'mycredentials-segment-private': '私有',
        'mycredentials-segment-private-intro': '凭证仅存在您的身份钱包中，其他人不可见。',
        'mycredentials-segment-public': '公开',
        'mycredentials-segment-public-intro': '已发布到链上的证书，每个人都可以看到。',
        'mycredentials-segment-notconform': '不符合',
        'mycredentials-segment-conform': '符合',
        'mycredentials-segment-conform-intro': '所有应用都可以共享的具有标准化类型的凭证，正在增加 DID 的使用率。',
        'mycredentials-segment-issuedbyuser': '由我创建',
        'mycredentials-segment-issuedbyuser-intro': '我使用身份钱包创建的凭证。',
        'mycredentials-segment-issuedbyothers': '由其他人创建',
        'mycredentials-segment-issuedbyothers-intro': '由第三方应用创建的凭证。',
        ...
        'published-did-not-required': '不需要公开身份',
        ...
        'credential-info-type-nationality': '国籍',
        ...
        'credential-info-type-facebook': '脸书',
        'credential-info-type-instagram': '照片墙',
        'credential-info-type-twitter': '推特',
        'credential-info-type-snapchat': 'Snapchat',
        'credential-info-type-telegram': '电报',
