export const zh = {
    ...
    'launcher': {
        ...
        'other': '其它',
        'backup-title': '身份未备份',
        'backup-message': '将您身份保存为纸质密钥是非常重要的一步，因为这是以后恢复它的唯一方法。',
        'backup-button': '立即备份',
        'backup-reminder-backup': '立即备份',
        'backup-reminder-skip': '跳过',
        'backup-reminder-skip-in': '跳过 ({{seconds}})',
        'profile-selector-title': '身份',
        'profile-current': '当前',
        'profile-add': '添加身份',
        'profile-add-sub': '创建或导入身份',
        'add-profile-title': '添加身份',
        'add-profile-heading': '添加身份',
        'add-profile-sub': '创建新身份，或导入您已拥有的身份。',
        'add-profile-create': '创建新身份',
        'add-profile-create-sub': '从全新的身份开始',
        'add-profile-import': '导入现有身份',
        'add-profile-import-sub': '通过助记词恢复身份',
        ...
        'app-crcouncil-election-description': 'Elastos 委员选举',
        'app-cr-proposal': '提案',
        'app-crproposal-description': '参与社区运营共治',
        'app-cr-suggestion': '建议',
        ...
        'app-crcouncil-registration': 'Elastos 委员参选',
        'app-crcouncil-registration-description': 'Elastos 委员参选管理',
        'app-redpackets': '红包',
        'app-redpackets-description': '分享快乐或宣传您的项目，发送红包!',
        'onboard-feature-unavailable': '此功能已不再可用',
        'hub-section-blockchain': 'Elastos 区块链',
        'hub-section-dao': 'Elastos DAO',
        'hub-statistics-description': 'Elastos 网络统计',
        'home-pillar-value': '价值',
        'home-pillar-value-sub': '钱包、代币与质押',
        'home-pillar-apps': '应用',
        ...
        'no-news': '暂无消息。可以从您收藏的 dApps 中添加更多新闻小组件。',
        'no-news-with-feeds': '暂无消息。可以从您收藏的 dApps 中添加更多新闻小组件，或使用 Feeds 应用程序订阅您关注的人和项目。',
        'try-feeds': '启动 Feeds',
