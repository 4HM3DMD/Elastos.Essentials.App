...
export const lazyWeb3Import = async (): Promise<typeof Web3> => {
  if (!importsCache['web3']) importsCache['web3'] = await import('web3');

  return importsCache['web3'].default;
};

export const lazyWeb3UtilsImport = async (): Promise<{ sha3: typeof sha3 }> => {
  if (!importsCache['web3-utils']) importsCache['web3-utils'] = await import('web3-utils');
...
export const lazyEthersImport = async (): Promise<{
  ...
  if (!importsCache['ethers']) importsCache['ethers'] = await import('ethers');
...
export const lazyEthersLibUtilImport = async (): Promise<{
  ...
  if (!importsCache['ethers/lib/utils']) importsCache['ethers/lib/utils'] = await import('ethers/lib/utils');
...
export const lazyUniswapSDKCoreImport = async (): Promise<{
  CurrencyAmount: typeof CurrencyAmount;
  Token: typeof Token;
  Percent: typeof Percent;
}> => {
  if (!importsCache['@uniswap/sdk-core']) importsCache['@uniswap/sdk-core'] = await import('@uniswap/sdk-core');
...
export const lazyCustomUniswapSDKImport = async (): Promise<{ Pair: typeof Pair; Trade: typeof Trade }> => {
  if (!importsCache['src/app/thirdparty/custom-uniswap-v2-sdk/src'])
    importsCache['src/app/thirdparty/custom-uniswap-v2-sdk/src'] = await import(
      'src/app/thirdparty/custom-uniswap-v2-sdk/src'
    );
...
export const lazyPhishingDetectorImport = async (): Promise<typeof PhishingDetector> => {
  if (!importsCache['eth-phishing-detect']) importsCache['eth-phishing-detect'] = await import('eth-phishing-detect');
...
export const lazyEllipticImport = async (): Promise<{ ec: typeof ec }> => {
  if (!importsCache['elliptic']) importsCache['elliptic'] = await import('elliptic');
...
export const lazyTronWebImport = async (): Promise<any> => {
  if (!importsCache['tronweb']) importsCache['tronweb'] = await import('tronweb');
