...
export class MasterWalletBuilder {
  public static newFromSerializedWallet<
    SerializedWalletType extends SerializedMasterWallet
  >(serialized: SerializedWalletType): MasterWallet {
    switch (serialized.type) {
      case WalletType.STANDARD:
        return StandardMasterWallet.newFromSerializedWallet(
          serialized as SerializedStandardMasterWallet
        );
      case WalletType.LEDGER:
        return LedgerMasterWallet.newFromSerializedWallet(
          serialized as unknown as SerializedLedgerMasterWallet
        );
      case WalletType.MULTI_SIG_STANDARD:
        return StandardMultiSigMasterWallet.newFromSerializedWallet(
          serialized as unknown as SerializedStandardMultiSigMasterWallet
        );
